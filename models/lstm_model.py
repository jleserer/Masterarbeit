...
Architecture & Hyperparameters (based on paper comparison):
  - Layers: 2 stacked LSTM layers (config.LSTM_UNITS, default [128, 64])
...
from config import LSTM_UNITS as _CONFIG_LSTM_UNITS, LOOKBACK_WINDOW as _CONFIG_LOOKBACK_WINDOW
from models.base_keras_model import BaseKerasTimeSeriesModel


class LSTMModel(BaseKerasTimeSeriesModel):
    """LSTM-based stock price predictor."""

    MODEL_LABEL = 'LSTM'
    LOOKBACK_WINDOW = _CONFIG_LOOKBACK_WINDOW
    LSTM_UNITS = list(_CONFIG_LSTM_UNITS)
    ...
    def build_model(self):
        ...
        print("\nModel Architecture:")
        self.model.summary()
        print(f"\nHyperparameters: LSTM Units={self.LSTM_UNITS}, "
...
if __name__ == "__main__":
    ...
    LSTMModel(data_path).run_full_pipeline()
